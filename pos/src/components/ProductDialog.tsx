        ...
        <div className="md:w-1/3 relative">
          {itemDoc?.image ? (
            <img
              src={itemDoc.image}
              alt={itemDoc.name}
              className="w-full min-h-96 h-full object-cover rounded-t-lg md:rounded-s-lg md:rounded-e-none filter saturate-75 brightness-95"
              ...
              onError={(e) => {
                ...
                if (parent) {
                  ...
                  placeholder.className = 'w-full h-96 bg-gray-200 flex items-center justify-center text-[8rem] text-gray-400 font-medium rounded-t-lg md:rounded-s-lg md:rounded-e-none';
            ...
            <div className="w-full min-h-96 h-full bg-gray-200 flex items-center justify-center text-[8rem] text-gray-400 font-medium rounded-t-lg md:rounded-s-lg md:rounded-e-none">
