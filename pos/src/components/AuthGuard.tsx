    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-2">{t('errors.access_denied')}</h2>
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-2">{t('errors.configuration_error')}</h2>
          <p className="text-gray-600">{t('errors.pos_profile_not_configured')}</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-2">{t('errors.permission_required')}</h2>
          <p className="text-gray-600">{t('errors.permission_denied')}</p>
          <p className="text-sm text-gray-500 mt-2">
            {t('errors.required_roles', { roles: posProfile.role_allowed_for_billing.map(r => r.role).join(', ') })}
          </p>
          <Button 
            variant="outline"
            className="mt-4"
